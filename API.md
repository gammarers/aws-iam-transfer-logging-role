...
| <code><a href="#@gammarers/aws-iam-transfer-logging-role.IamTransferLoggingRole.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="@gammarers/aws-iam-transfer-logging-role.IamTransferLoggingRole.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="@gammarers/aws-iam-transfer-logging-role.IamTransferLoggingRole.with.parameter.mixins"></a>
